...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactRouterLibHashHistory = __webpack_require__(190);

	//公共组件视图

	var _viewsCommon = __webpack_require__(192);

	var _viewsIndex = __webpack_require__(1);

	var _viewsIndex2 = _interopRequireDefault(_viewsIndex);

	var _viewsArticle = __webpack_require__(193);

	var _viewsArticle2 = _interopRequireDefault(_viewsArticle);

	var _viewsWrite = __webpack_require__(194);

	var _viewsWrite2 = _interopRequireDefault(_viewsWrite);

	var _viewsAbout = __webpack_require__(195);

	var _viewsAbout2 = _interopRequireDefault(_viewsAbout);

	var App = _react2['default'].createClass({
	  displayName: 'App',

	  render: function render() {
	    return _react2['default'].createElement('div', { className: 'wrap' }, _react2['default'].createElement(_viewsCommon.LogoView, null), _react2['default'].createElement('nav', null, _react2['default'].createElement('ul', null, _react2['default'].createElement('li', null, _react2['default'].createElement(_reactRouter.Link, { to: '/index' }, 'Index')), _react2['default'].createElement('li', null, _react2['default'].createElement(_reactRouter.Link, { to: '/write' }, 'Write')), _react2['default'].createElement('li', null, _react2['default'].createElement(_reactRouter.Link, { to: '/about' }, 'About')))), _react2['default'].createElement('div', { className: 'content' }, this.props.children), _react2['default'].createElement(_viewsCommon.FooterView, null));
	  }
	});
	...
	var routes = {
	  path: '/',
	  component: App,
	  childRoutes: [{ path: ' ', component: _viewsIndex2['default'] }, { path: 'index', component: _viewsIndex2['default'] }, { path: 'article/:title', component: _viewsArticle2['default'] }, { path: 'write', component: _viewsWrite2['default'] }, { path: 'about', component: _viewsAbout2['default'] }]
	};

	_react2['default'].render(_react2['default'].createElement(_reactRouter.Router, { history: _reactRouterLibHashHistory.history, children: routes }), document.body);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _articleList = __webpack_require__(158);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _superagent = __webpack_require__(187);
	...
	var ArticleList = _react2['default'].createClass({
		...
		getInitialState: function getInitialState() {
			var data = [{ title: "test1", img: "./images/banner1.png", text: "简要内容1...........", author: "uncoder", date: "2014-2-30" }, { title: "test2", img: "./images/banner2.png", text: "简要内容2...........", author: "uncoder", date: "2015-12-23" }, { title: "test3", img: "./images/banner3.png", text: "简要内容3...........", author: "uncoder", date: "2016-2-10" }];
			return { data: data };
		},
		componentWillMount: function componentWillMount() {
			var self = this;
			_superagent2['default'].get('http://127.0.0.1:1337/getArticles').set('Accept', 'application/json').end(function (err, res) {
				var data = res.body;
		...
		render: function render() {
			...
			var NodesList = data.map(function (item, i) {
				return _react2['default'].createElement(ArticleItem, { data: item });
			});
			return _react2['default'].createElement(
				'div',
				null,
	...
	var ArticleItem = _react2['default'].createClass({
		displayName: 'ArticleItem',

		render: function render() {
			var data = this.props.data;
			var href = '/article/' + this.props.data.title;
			return _react2['default'].createElement(
				'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Link2 = __webpack_require__(181);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AsyncUtils = __webpack_require__(163);

	var _RouteUtils = __webpack_require__(164);

	var _RoutingUtils = __webpack_require__(165);

	var _PropTypes = __webpack_require__(172);

	var _RouterContextMixin = __webpack_require__(177);

	var _RouterContextMixin2 = _interopRequireDefault(_RouterContextMixin);

	var _ScrollManagementMixin = __webpack_require__(178);

	var _ScrollManagementMixin2 = _interopRequireDefault(_ScrollManagementMixin);

	var _Location = __webpack_require__(173);

	var _Transition = __webpack_require__(180);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _URLUtils = __webpack_require__(166);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _qs = __webpack_require__(167);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _History = __webpack_require__(176);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NavigationTypes = __webpack_require__(174);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DOMHistory2 = __webpack_require__(191);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _History2 = __webpack_require__(176);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LogoView = _react2["default"].createClass({
		displayName: "LogoView",
	...
	//定义footer
	var FooterView = _react2["default"].createClass({
	...
	module.exports = { LogoView: LogoView, FooterView: FooterView };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ArticleView = _react2['default'].createClass({
		...
		componentWillMount: function componentWillMount() {
			...
			var self = this;
			_superagent2['default'].get('http://127.0.0.1:1337/getArticle?title=' + title).set('Accept', 'application/json').end(function (err, res) {
				var data = res.body;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var WriteView = _react2["default"].createClass({
	  displayName: "WriteView",
	  ...
	  render: function render() {
	    return _react2["default"].createElement(
	      ...
	      _react2["default"].createElement(
	        "form",
	        { action: "http://127.0.0.1:1337/postArticle", method: "post" },
	        _react2["default"].createElement(
	          "div",
	          ...
	          _react2["default"].createElement("input", { type: "text", placeholder: "这是文章标题啊...", name: "title" })
	        ),
	        _react2["default"].createElement(
	          "div",
	          { className: "write-img" },
	        ...
	        _react2["default"].createElement("input", { type: "submit", value: "确定" })
	      )
	    );
	  }
	});
